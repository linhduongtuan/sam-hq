...
data_path = "/Users/linh/Downloads/cv/torch-em/experiments/training_data/hpa/hpa_dataset_v2"

patch_shape = (512, 512)
def get_hpa_segmentation_dataloaders(path):
    train_loader = get_hpa_segmentation_loader(path, 
                                                    patch_shape=patch_shape,
                                                    batch_size=8,
                                                    channels=["microtubules", "protein", "nuclei", "er"],
                                                    download=True,
                                                    split='train')
    val_loader = get_hpa_segmentation_loader(path, 
                                                  patch_shape=patch_shape,
                                                  batch_size=8,
                                                  channels=["microtubules", "protein", "nuclei", "er"],
                                                  download=True,
...
train_loader, val_loader = get_hpa_segmentation_dataloaders(path=data_path)
